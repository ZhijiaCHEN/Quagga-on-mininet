    ...
    def __init__(self):
        ...
        for r in self.routers:
            if r in self.quagga:
                ...
                self.addSwitch(r, notInNamespace=True)
        self.routerASDict = {R1:3, R2:3, R3:3, R4:3, R5:1}
        routerLinks = [(R1, R3), (R2, R3), (R1, R4), (R2, R4), (R3, R4), (R1, R5), (R2, R5)]
...
def genBgpdConf(topo):
    for router in topo.quagga:
        ...
        for i in range(topo.routerIntfCntDict[router]):
            ...
            if nRouter == "R4": # Bolero communicates with quagga routers through R4
