    ...
    for router in net.switches:
        ...
        if router.name == "R1_1":
            ...
            for intf in topo.intfDict[router.name]:
                ...
                router.cmd('/home/zhijia/miniconda3/bin/python /home/zhijia/git/yabgp/bin/yabgpd --bgp-local_addr={0} --bgp-local_as=3 --bgp-remote_addr={1} --bgp-remote_as=3 --rest-bind_host={0}  2>/home/zhijia/git/Quagga-on-mininet/Bolero/yabgp-api-{2}.log &'.format(getIntfIP(intf, maskLen=None), getIntfIP(topo.linkEndDict[intf], maskLen=None), intf))
            continue
